 ...
 * @version 创建时间：2016年11月24日 下午3:39:26
 * 
 */
public interface ConversionCountryReportDao {
	public ArrayList<Document> getApiReportDocument(MongoUtil mongoUtil);
	public void insertIntoMongo(IdentityHashMap<String, ConversionReportMongoBean> countryUpdateMap,MongoUtil mongoUtil);
}
