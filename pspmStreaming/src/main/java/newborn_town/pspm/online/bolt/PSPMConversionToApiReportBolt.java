 ...
 *
 */
public class PSPMConversionToApiReportBolt extends BaseBasicBolt {

	private static final long serialVersionUID = -3741400208496719631L;

	static Logger logger = Logger
			.getLogger(PSPMConversionToApiReportBolt.class);
	...
	public void prepare(@SuppressWarnings("rawtypes") Map stormConf,
		...
		mongoUtil = new MongoUtil("pspm", "apiReport");
	...
	public void execute(Tuple input, BasicOutputCollector collector) {
		...
		documentStr.append("_id", mogoDBMapKey).append("day", day)
				...
				.append("country", geo)
				.append("campaign_id", Integer.parseInt(campaign_id))
		...
		documentInc.append("_id", mogoDBMapKey)
				...
				.append("cost", reportDaypayout + cost)
	...
	private void insterOrUpdateDB() {
		...
		logger.info("PSPMConversionToApiReportBolt 插入或更新"
